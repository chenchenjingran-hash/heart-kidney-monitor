...
- The header's “记录今天” button opens the daily-record view and selects the current local date. Pending auto-save edits for the previously selected date must be persisted before the date changes or the form rerenders.
